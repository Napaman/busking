        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              Welcome to the Busking in the Metaverse Page, thank you for supporting independent musicians. <span className="emoji">😃</span><br />
              Contact us at Feelmyflo for any queries.<span className="emoji">🚀</span><br />
              <br />
              Keep safe and enjoy the music! <span className="emoji">❤️</span>
            </div>

            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                <h2>Whitelist Disabled</h2>
                <p>
                Connect wallet. 
                </p>
